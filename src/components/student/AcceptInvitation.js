    ...
    componentDidMount() {
        const axiosOptions = {
          url:
            ...
            "student/invitations-list?event_token=" +
      ...
      handleSubmit(event,id) {
        ...
        axios({
          method: 'put',
          url: process.env.React_App_API_URL + "student/confirm-invitation",
          headers: {
                Authorization: `Bearer ${this.state.token}`,
              },
          data: {
                                                     ...
                                                     <table>
                                                            ...
                                                            {this.state.data.map(i => 
                                                                <tr className='data_row'>
                                                                    ...
                                                                    <td>{i.last_name}</td>
                                                                    <td>{i.email}</td>
                                                                    <button className="button" onClick={(event) => this.handleSubmit(event , i.idea_id)}>Accept Invitation</button>
                                                                </tr>
