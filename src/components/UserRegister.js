                ...
                <div class="row form-group-margin">
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="name"
                      getContent={() => {
                        return this.state.error_messages.first_name;
                      }}
                    />

                    <input
                      type="text"
                      data-tip-disable={this.state.data_tip_disable_first_name}
                      ...
                      data-tip=""
                      className={this.state.first_name_validation}
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="last_name_r"
                      getContent={() => {
                        return this.state.error_messages.last_name;
                      }}
                    />
                    ...
                    <input
                      type="text"
                      name="last_name"
                      data-tip-disable={this.state.data_tip_disable_last_name}
                      value={this.state.last_name}
                      data-for="last_name_r"
                      className={this.state.last_name_validation}
                  ...
                  <div class="col-12 col-md-12 col-lg-12 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="email"
                      getContent={() => {
                        return this.state.error_messages.email;
                      }}
                    />
                    ...
                    <input
                      type="text"
                      name="email"
                      data-tip-disable={this.state.data_tip_disable_email}
                      value={this.state.email}
                      className={this.state.email_validation}
                      data-for="email"
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="password"
                      getContent={() => {
                        return this.state.error_messages.password;
                      }}
                    />
                    ...
                    <input
                      type="password"
                      name="password"
                      data-tip-disable={this.state.data_tip_disable_password}
                      ...
                      data-effect="solid"
                      data-event-off="click"
                      className={this.state.password_validation}
                      onChange={this.handleChange}
                    />
                  </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <input
                      ...
                      data-tip-disable={
                        this.state.data_tip_disable_confirm_password
                      }
                      value={this.state.confirm_password}
                      className={this.state.confirm_password_validation}
                      onChange={this.handleChange}
                    />
                  </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="city"
                      getContent={() => {
                        return this.state.error_messages.city;
                      }}
                    />
                    ...
                    <input
                      type="text"
                      name="city"
                      data-tip-disable={this.state.data_tip_disable_city}
                      data-for="city"
                      value={this.state.city}
                      className={this.state.city_validation}
                      ref={(ref) => (this.city_ref = ref)}
                      data-tip=""
                      data-background-color="red"
                      data-effect="solid"
                      data-event-off="click"
                  ...
                  <div class="col-12 col-md-6 col-lg-6 m-0 p-2 input-group">
                    ...
                    <ReactTooltip
                      id="mobile_no"
                      getContent={() => {
                        return this.state.error_messages.mobile_no;
                      }}
                    />
                    ...
                    <input
                      ...
                      name="mobile_no"
                      data-for="mobile_no"
                      data-tip-disable={this.state.data_tip_disable_mobile_no}
                      value={this.state.mobile_no}
                      data-for="mobile_no"
                      ref={(ref) => (this.mobile_no_ref = ref)}
                      data-tip=""
                      data-background-color="red"
                      data-effect="solid"
                      data-event-off="click"
                      className={this.state.mobile_no_validation}
                      onChange={this.handleChange}
                    />
                  </div>
